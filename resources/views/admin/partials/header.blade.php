@php
    ...
    $menu = [
        ...
        'knowledge' => ['route' => 'admin.knowledge-bases.index', 'name' => __('admin.nav.knowledge')],
        'tasks' => ['route' => 'admin.tasks.index', 'name' => __('admin.nav.distribute')],
        'distribution' => ['route' => 'admin.distribution.index', 'name' => __('admin.nav.distribution')],
        'ai_prompts' => ['route' => 'admin.ai-prompts', 'name' => __('admin.nav.ai_prompts')],
        'site_settings' => ['route' => 'admin.site-settings.index', 'name' => __('admin.nav.site_settings')],
    ];
    // Soft-hide noisy menus from demo focus path (recoverable by restoring previous $menu).
    // Hidden: analytics, articles, materials, ai_configurator.
    if (!$isSuperAdmin) {
    ...
    $subMap = [
        ...
        'admin.articles.create' => 'tasks',
        'admin.articles.edit' => 'tasks',
        'admin.articles.index' => 'tasks',
        'admin.categories.index' => 'knowledge',
        'admin.categories.create' => 'knowledge',
        'admin.categories.edit' => 'knowledge',
        'admin.authors.index' => 'knowledge',
        'admin.authors.create' => 'knowledge',
        'admin.authors.edit' => 'knowledge',
        'admin.authors.detail' => 'knowledge',
        'admin.keyword-libraries.index' => 'knowledge',
        'admin.keyword-libraries.create' => 'knowledge',
        'admin.keyword-libraries.edit' => 'knowledge',
        'admin.keyword-libraries.detail' => 'knowledge',
        'admin.keyword-libraries.detail.update' => 'knowledge',
        'admin.keyword-libraries.keywords.store' => 'knowledge',
        'admin.keyword-libraries.keywords.delete' => 'knowledge',
        'admin.keyword-libraries.import' => 'knowledge',
        'admin.title-libraries.index' => 'knowledge',
        'admin.title-libraries.create' => 'knowledge',
        'admin.title-libraries.edit' => 'knowledge',
        'admin.title-libraries.detail' => 'knowledge',
        'admin.title-libraries.titles.store' => 'knowledge',
        'admin.title-libraries.titles.delete' => 'knowledge',
        'admin.title-libraries.import' => 'knowledge',
        'admin.title-libraries.ai-generate' => 'knowledge',
        'admin.title-libraries.ai-generate.submit' => 'knowledge',
        'admin.image-libraries.index' => 'knowledge',
        'admin.image-libraries.create' => 'knowledge',
        'admin.image-libraries.edit' => 'knowledge',
        'admin.image-libraries.detail' => 'knowledge',
        'admin.image-libraries.images.upload' => 'knowledge',
        'admin.image-libraries.images.delete' => 'knowledge',
        'admin.image-libraries.detail.update' => 'knowledge',
        'admin.knowledge-bases.index' => 'knowledge',
        'admin.knowledge-bases.create' => 'knowledge',
        'admin.knowledge-bases.edit' => 'knowledge',
        'admin.knowledge-bases.detail' => 'knowledge',
        'admin.knowledge-bases.upload' => 'knowledge',
        'admin.knowledge-bases.detail.update' => 'knowledge',
        'admin.url-import' => 'knowledge',
        'admin.materials.index' => 'knowledge',
        'admin.ai-models.index' => 'ai_prompts',
        'admin.ai.configurator' => 'ai_prompts',
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center gap-3 lg:gap-4 min-w-0">
            ...
            @endphp
            <a href="{{ $suitePublicUrl }}/suite" target="_blank" rel="noreferrer" class="hidden sm:inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium text-emerald-800 bg-emerald-50 border border-emerald-100 hover:bg-emerald-100">
                回 GEO Suite
            </a>
